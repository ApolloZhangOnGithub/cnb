...
from src.common import ClaudesEnv, _write_config_toml, is_suspended
from src.swarm_backend import SessionBackend, TmuxBackend, detect_backend
...
class SwarmManager:
    ...
    def build_system_prompt(self, name: str) -> str:
        from src.roles import load_manifest, resolve_role_for_identity
