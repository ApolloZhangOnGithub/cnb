...
from src.common import is_privileged, parse_flags, validate_identity
...
def _github_app_pr_env(project_root: Path, session_name: str) -> dict[str, str] | None:
    ...
    try:
        from src.github_app_identity import create_repo_scoped_token, resolve_repository_installation_id
