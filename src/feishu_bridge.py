...
from src.swarm import CODEX_PERMISSION_FLAGS
from src.tmux_utils import has_session, tmux_send
...
def _pilot_role_section(cfg: FeishuBridgeConfig) -> str:
    from src.roles import load_manifest, resolve_role_for_pilot
...
def _candidate_project_roots(cfg: FeishuBridgeConfig, *, max_candidates: int = 40) -> list[Path]:
    ...
    try:
        from src.global_registry import list_projects
