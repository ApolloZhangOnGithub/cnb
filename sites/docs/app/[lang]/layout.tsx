    ...
    <footer>
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <a href="https://c-n-b.space" style={{ textDecoration: 'none' }}>
            <CnbLogo />
          </a>
          <div style={{ display: 'flex', gap: '1.5rem' }}>
            <a href="https://github.com/ApolloZhangOnGithub/cnb" target="_blank" rel="noreferrer" aria-label="GitHub" style={{ color: 'var(--color-fd-muted-foreground)' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, minmax(120px, auto))', gap: '2rem' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              ...
              <li><a href="https://blog.c-n-b.space/feed" style={linkStyle}>Blog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.25rem' }}>
              <li><a href="https://github.com/ApolloZhangOnGithub/cnb" target="_blank" rel="noreferrer" style={linkStyle}>GitHub</a></li>
