...
# Match both `.cnb/board.db` (current runtime DB) and `.cnb/board/...` (any future
# subdirectory). The trailing separator distinction matters: a bare `.cnb/board`
# prefix catches the canonical SQLite file as well as any sibling directory.
BOARD_PREFIXES = ("board/", ".cnb/", ".claudes/")
