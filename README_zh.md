...
**[LeWorldModel / JEPA 复现计划](https://github.com/ApolloZhangOnGithub/cnb/issues/164)** — 计划中的研究 demo：用 cnb 团队复现 LeCun 的 LeWM 论文，分工覆盖论文精读、独立实现、数据管线和复现报告。目标是展示从论文笔记到 PushT 评估的看板协作路径，目前不是已完成结果。
